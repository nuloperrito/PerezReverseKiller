...
#include <stdarg.h>
#include <strings.h>
#include "com_perez_netdiag_Service_LDNetSocket.h"
#include "Provider.h"
#include "utils.h"
#define OUT_LEN 1000
...
JNIEXPORT void JNICALL Java_com_perez_netdiag_Service_LDNetSocket_startJNITelnet(JNIEnv *env, jobject obj, jstring command, jstring port){
