...
#include <stdarg.h>
#include "com_perez_netdiag_Service_LDNetTraceRoute.h"
#include "Provider.h"
#include "utils.h"
...
JNIEXPORT void JNICALL Java_com_perez_netdiag_Service_LDNetTraceRoute_startJNICTraceRoute(JNIEnv *env, jobject obj, jstring command)
{
