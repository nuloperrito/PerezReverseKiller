...
public class ArscActivity extends AppCompatActivity implements OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.arsc_string_list);
    ...
    public class stringListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup arg2) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.arsc_res_string_item, null);
    ...
    public static AlertDialog.Builder showMessage(Context activity, String message) {
        return new AlertDialog.Builder(activity).setMessage(message).setNegativeButton(android.R.string.ok, null)
