...
public class MethodItemEditorActivity extends AppCompatActivity {
	...
	private boolean save(DexFile dexFile) {
		...
		try {
			...
			RealFuncUtil.showDlgMsg(this, getString(R.string.method_desc_error), RealFuncUtil.getFullException(e), null);
			return false;
		}
		try {
			if(method.codeItem != null) {
			...
			RealFuncUtil.showDlgMsg(this, getString(R.string.regcnt_error), RealFuncUtil.getFullException(e), null);
		}
		return true;
	}
