...
public class PackageActivity extends AppCompatActivity {
    ...
    public void deCode(String fileName) {
        ...
        try {
            ...
            Toast.makeText(PackageActivity.this, "Error：" + e.toString(), Toast.LENGTH_LONG).show();
            return;
        }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(PackageActivity.this, "Succeeded in decompiling", Toast.LENGTH_LONG).show();
                        }
                    });
                } catch(InterruptedException e) {
                    Toast.makeText(PackageActivity.this, "Error message: " + e.toString(), Toast.LENGTH_LONG).show();
                }
            }
        };
        ...
        classAdapter.setOnItemClickListener((view, viewHolder, position) -> {
            if(viewHolder instanceof ClassHolder) {
                ...
                if(R.mipmap.package_obj == jNode.getIcon()) {
                    ...
                    Toast.makeText(PackageActivity.this, ((JClass) jNode).getFullName(), Toast.LENGTH_LONG).show();
                }
            }
        });
