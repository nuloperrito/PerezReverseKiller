...
public class PerezReverseKillerMain extends AppCompatActivity {
    ...
    private void updateAndFilterFileList(final String query) {
        ...
        if(files != null) {
            ...
            switch(rpf.GetWhich()) {
                case "type":
                    Collections.sort(work, MiscellaneousFunctions.sortByType);
                    break;
                case "date":
                    Collections.sort(work, MiscellaneousFunctions.sortByDate);
                    break;
                case "size":
                    Collections.sort(work, MiscellaneousFunctions.sortBySize);
                    break;
                case "name":
                default:
                    Collections.sort(work, MiscellaneousFunctions.sortByName);
                    break;
            }
    ...
    public void SystemInfo() {
        ...
        new Thread(() -> {
            ...
            List<String> sis = MiscellaneousFunctions.getSelfInstallSource(this);
