package com.perez.netdiag.Utils;
    ...
    public static void checkPermission(Activity activity,Runnable runnable) {
        ...
        if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission
                ...
                Toast.makeText(activity, "Please activate relevant permissions, otherwise you will not be able to use this application normally!", Toast.LENGTH_LONG).show();
            }
