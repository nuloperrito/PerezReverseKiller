...
public class PreviewFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MatadorApp.isInitProxy) {
            harLog = ((MatadorApp) getActivity().getApplication()).proxy.getHar().getLog();
    ...
    public class ClickListner implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if(harLog.getEntries().indexOf(harEntry)>=0) {
                ...
                intent.putExtra("pos", ((MatadorApp) getActivity().getApplication()).proxy.
