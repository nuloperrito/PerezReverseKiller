package com.perez.netdiag.Activity;
...
import com.perez.netdiag.Adapter.PageFilterAdapter;
import com.perez.netdiag.Bean.PageBean;
import com.perez.netdiag.Fragment.BaseFragment;
import com.perez.netdiag.Fragment.BackHandledInterface;
import com.perez.netdiag.Fragment.NetworkFragment;
import com.perez.netdiag.Fragment.PreviewFragment;
import com.perez.netdiag.Fragment.WebViewFragment;
import com.perez.revkiller.R;
import com.perez.revkiller.MatadorApp;

import com.perez.netdiag.Utils.DeviceUtils;
import com.perez.netdiag.Utils.FileUtil;
import com.perez.netdiag.Utils.SharedPreferenceUtils;
import com.perez.netdiag.Utils.ZipUtils;
import com.perez.netdiag.View.LoadingDialog;
...
public class NDGAct extends AppCompatActivity implements BackHandledInterface {
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                Toast.makeText(getApplicationContext(), "Press it again to exit the program", Toast.LENGTH_LONG).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                shouldExitSearchView = newText.isEmpty();
                return false;
            }
        });
        return true;
    ...
    protected void onStart() {
        ...
        registerReceiver(receiver, new IntentFilter("proxyfinished"), Context.RECEIVER_NOT_EXPORTED);
        handleUriStartupParams();
    }
    ...
    public void showFilter(final Context context, final int type) {
        BrowserMobProxy proxy = ((MatadorApp) getApplication()).proxy;
    ...
    public void initFloatingActionMenu() {
        ...
        binding.fabClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ((MatadorApp)getApplication()).proxy.getHar().getLog().clearAllEntries();
                        PreviewFragment.getInstance().notifyHarChange();
                    }
                });
                builder.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
    ...
    public void showUaDialog() {
        ...
        builder.setPositiveButton(android.R.string.ok, buttonListener);
        builder.setNegativeButton(android.R.string.cancel, buttonListener);
        builder.create().show();
    }
    ...
    public void showHostDialog(){
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                DeviceUtils.changeHost(((MatadorApp)getApplication()).proxy,editText.getText()+"");
            }
        });
