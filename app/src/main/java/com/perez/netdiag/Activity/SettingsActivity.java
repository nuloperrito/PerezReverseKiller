...
public class SettingsActivity extends AppCompatPreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference.getKey().equals("system_host")) {
            DeviceUtils.changeHost(((MatadorApp)getApplication()).proxy,newValue.toString());
            hostPreference.setSummary(getHost());
        }

        
        if (preference.getKey().equals("enable_filter")) {
            Toast.makeText(this, R.string.restart_effect_tips, Toast.LENGTH_LONG).show();
        }
        return true;
    }
    ...
    public String getHost() {
        ...
        BrowserMobProxy browserMobProxy = ((MatadorApp) getApplication()).proxy;
